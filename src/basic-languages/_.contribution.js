...
function loadLanguage(languageId) {
	return __awaiter(this, void 0, void 0, function () {
		...
		return __generator(this, function (_a) {
			switch (_a.label) {
				case 0:
					return [4 /*yield*/, LazyLanguageLoader.getOrCreate(languageId).load()];
				case 1:
					_a.sent();
					model = monaco_editor_core_1.editor.createModel('', languageId);
					model.dispose();
					return [2 /*return*/];
			}
		});
		...
		create: function () {
			return __awaiter(_this, void 0, void 0, function () {
				...
				return __generator(this, function (_a) {
					switch (_a.label) {
						case 0:
							return [4 /*yield*/, lazyLanguageLoader.load()];
						case 1:
							mod = _a.sent();
